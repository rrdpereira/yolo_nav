...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1291, 716) # one window (720, 560); two windows (1291, 716)
        self.graphicsView_2 = QtWidgets.QGraphicsView(Form)
        self.graphicsView_2.setGeometry(QtCore.QRect(5, 30, 608, 608)) # one window (5, 5, 1, 1); two windows (5, 30, 608, 608)
        ...
        self.navigate_button.setGeometry(QtCore.QRect(250, 490, 231, 31)) # one window (250, 490, 231, 31); two windows (380, 670, 231, 31)
        self.navigate_button.setObjectName("navigate_button")
        self.camera_slider = QtWidgets.QSlider(Form)
        self.camera_slider.setGeometry(QtCore.QRect(5, 5, 1, 1)) # one window (5, 5, 1, 1); two windows (10, 680, 351, 16)
        ...
        self.graphicsView.setGeometry(QtCore.QRect(640, 30, 640, 480)) # one window (30, 5, 650, 490); two windows (640, 30, 640, 480)
